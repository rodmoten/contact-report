...
public class ReportApiController implements ReportApi {
    ...
    public ResponseEntity<String> report(@ApiParam(value = "",required=true) @PathVariable("contributor_id") String contributorId,@ApiParam(value = "Report data" ,required=true )  @Valid @RequestBody Report body) {
